...
export const TESTIMONIALS: TestimonialItem[] = [
  ...
  },
  {
    ...
    rating: 5,
    text: 'I submitted a flight enquiry for my multi-city student trip to Seattle. The airline expert gave me a custom route combination that saved me over $450! Professional, transparent pricing.',
  ...
  },
  {
    ...
    location: 'Chicago, IL',
    rating: 5,
    text: 'Excellent corporate customer service. As a corporate lead, I rely on Nilhans Travels for all our international flight booking requirements. Fast response, and billing invoices shared on the spot.',
